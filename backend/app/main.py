...
def debug_db():
    ...
    return {
        "env_keys": env_keys,
        "settings_database_url": _mask_db_url(settings.DATABASE_URL),
        "os_environ_database_url_exists": os.environ.get("DATABASE_URL") is not None,
        "os_environ_database_url_val": _mask_db_url(os.environ.get("DATABASE_URL", ""))
    }
